    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_3923 = saturate((sin((_node_4237*(mul(_Object2World, v.vertex).g.r+node_420.r)*6.28318530718))*2.0+-1.0));
...
////// Emissive:
                float4 node_420 = _Time + _TimeEditor;
                float node_3923 = saturate((sin((_node_4237*(i.posWorld.g.r+node_420.r)*6.28318530718))*2.0+-1.0));
